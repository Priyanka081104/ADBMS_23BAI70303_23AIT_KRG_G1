...
-- Insert
INSERT INTO student (name, age, class) VALUES ('Priyanka', 20, '11th');


-- Delete
DELETE FROM student WHERE name = 'Priyanka';
...
INSERT INTO tbl_employee (emp_name, emp_salary) VALUES ('Priyanka', 50000);
SELECT * FROM tbl_employee_audit;

-- Delete and verify audit
DELETE FROM tbl_employee WHERE emp_name = 'Priyanka';
SELECT * FROM tbl_employee_audit;
